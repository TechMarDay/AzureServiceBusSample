...
namespace AzureServiceBusSample1
{
    class Program
    {
        static string connectionString = "Endpoint=sb://orderservicebustest.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=d40fQH2CCKhdAqT51Y3c0pNNDjkNnyzcep3SbKXfPIY=";
        static string queueName = "neworder";
